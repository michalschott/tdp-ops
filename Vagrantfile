...
hosts = [
  {name: 'prod', hostname: 'vm-rec-prod-app.kainos.com', ip: '172.16.253.59', environment: 'production', cpu: '2', mem: '4096', port_forward: [{guest: 80, host: 8080}, {guest: 8888, host: 8888}, {guest: 5432, host: 5432}]},
  ]
